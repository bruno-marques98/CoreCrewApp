...
namespace CoreCrewApp.Migrations
{
    ...
    [Migration("20241112161111_initial migration")]
            ...
            modelBuilder.Entity("CoreCrewApp.Models.AuditLog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            TableName = "Employee",
                            Timestamp = new DateTime(2024, 11, 12, 16, 11, 10, 350, DateTimeKind.Local).AddTicks(2989),
                        ...
                        new
                        {
                            ...
                            TableName = "Employee",
                            Timestamp = new DateTime(2024, 11, 12, 16, 11, 10, 350, DateTimeKind.Local).AddTicks(2992),
                            UserName = "Bruno Marquês"
                        });
                });
            ...
            modelBuilder.Entity("CoreCrewApp.Models.EmployeeBenefit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            EmployeeID = 1,
                            BenefitID = 1,
                            EnrollmentDate = new DateTime(2024, 11, 12, 16, 11, 10, 350, DateTimeKind.Local).AddTicks(2796)
                        },
                        new
                        {
                            EmployeeID = 2,
                            BenefitID = 2,
                            EnrollmentDate = new DateTime(2024, 11, 12, 16, 11, 10, 350, DateTimeKind.Local).AddTicks(2839)
                        });
                });
            ...
            modelBuilder.Entity("CoreCrewApp.Models.Notification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2024, 11, 12, 16, 11, 10, 350, DateTimeKind.Utc).AddTicks(2961),
                            Title = "Welcome"
                        },
                        new
                        {
                            ...
                            Timestamp = new DateTime(2024, 11, 12, 16, 11, 10, 350, DateTimeKind.Utc).AddTicks(2965),
                            Title = "Benefits"
                        });
                });
